...
<% 
	...
	String dbURL = "jdbc:mysql://localhost:3306/MyFitnessPal?useSSL=false";
...
<div class="main">
  ...
  <div>
  	<img src="./ImageServlet?id=<%=  rs.getString("id") %>&table=muscle_group" height="400" align="middle" style="display:block; margin:auto; max-width:100%; height:auto; max-height:400px;">
  	<form id="edit-muscle-group" action="EditMuscleGroup?id=<%=  rs.getString("id") %>" method="post" enctype="multipart/form-data">
  		<section class="first">
          	<fieldset class="first_fieldset">
                ...
                <br><label> Muscle Group Image: </label><br>
