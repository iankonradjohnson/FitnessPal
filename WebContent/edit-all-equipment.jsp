...
String query = "SELECT * FROM equipment WHERE user = ?";
...
<div class="main">
  ...
  <hr>
  <h1><i class="fas fa-edit"></i> Edit Your Uploaded Equipment </h1>
  
<%

if(rs.next() == false){
	out.println("<p> You do not have any equipment, Add Equipment  </p>");
	out.println("<p><br></p>");
	out.println("<p><br></p>");
	out.println("<p><br></p>");
	out.println("<p><br></p>");
	...
	do{	
		out.println("<div class=\"row\">  "  + 
				 "       <div class=\"column2\">  "  + 
				 "         <a href=\"edit-equipment.jsp?id=" + rs.getString("id") + "\">" +
				 ...
				 "           <p>Workout Type: " + rs.getString("workout_type") + "</p>  "  + 
				 "           <a href=\"edit-equipment.jsp?id=" + rs.getString("id") + "\">Click here to edit equipment.</a><br><br>"  + 
				 //"            <a href=\"delete-item.jsp?id=" + rs.getString("id") + "&table=equipment\">Delete equipment.</a><br>"  + 
				 "             "  + 
				 "             <br>  "  + 
				 "             <br>  "  + 
				 "             <br>  "  + 
