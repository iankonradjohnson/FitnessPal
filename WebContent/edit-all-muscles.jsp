...
String query = "SELECT *, (SELECT name FROM muscle_group " +
		"WHERE m.muscle_group_id = id ) AS muscle_group FROM muscle m WHERE user = ?";
...
<div class="main">
  ...
  <hr>
  <h1><i class="fas fa-search"></i> Edit Your Uploaded Muscles </h1>
  
<%

if(rs.next() == false){
	out.println("<p> You do not have any muscles </p>");
	out.println("<p><br></p>");
	out.println("<p><br></p>");
	out.println("<p><br></p>");
	out.println("<p><br></p>");
	...
	do{	
		out.println("<div class=\"row\">  "  + 
				 "       <div class=\"column2\">  "  + 
				 "         <a href=\"edit-muscle.jsp?id=" + rs.getString("id") + "\">" +
				 "          <div class=\"container2\">  "  + 
				 "			 <img src=\"./ImageServlet?id=" + rs.getString("id") + "&table=muscle\" height=\"400\" align=\"middle\" style=\"display:block; margin:auto; max-width:100%; height:auto; max-height:400px;\">  "  + 
				 "             <div class=\"middle\">  "  + 
				 ...
				 "           <p>Muscle Group: " + rs.getString("muscle_group") + "</p>  "  + 
				 "           <a href=\"edit-muscle.jsp?id=" + rs.getString("id") + "\">Click here to edit muscle.</a><br><br>"  + 
				// "            <a href=\"delete-item.jsp?id=" + rs.getString("id") + "&table=muscle\">Delete muscle.</a><br>"  + 
				 "             "  + 
				 "             <br>  "  + 
				 "             <br>  "  + 
				 "             <br>  "  + 
