...
Connection connection = DriverManager.getConnection(dbURL, "root", "BACHlover1234");
    String query = "SELECT * FROM muscle_group WHERE user = ?";
...
<div class="main">
  ...
  <hr>
  <h1><i class="fas fa-edit"></i> Edit Your Uploaded Muscle Groups</h1>
  
<%

if(rs.next() == false){
	out.println("<p> You do not have any muscle groups </p>");
	out.println("<p><br></p>");
	out.println("<p><br></p>");
	out.println("<p><br></p>");
	out.println("<p><br></p>");
	...
	do{	
		out.println("<div class=\"row\">  "  + 
				 "       <div class=\"column2\">  "  + 
				 "         <a href=\"edit-muscle-group.jsp?id=" + rs.getString("id") + "\">" +
				 "          <div class=\"container2\">  "  + 
				 "			 <img src=\"./ImageServlet?id=" + rs.getString("id") + "&table=muscle_group\" " + 
				 "                 alt=\"Bicep workout\" height=\"400\" align=\"middle\" style=\"display:block;" + 
				 "                 margin:auto; max-width:100%; height:auto; max-height:400px;\">  "  + 
				 "             <div class=\"middle\">  "  + 
				 ...
				 "            <a href=\"edit-muscle-group.jsp?id=" + rs.getString("id") + "\">Edit muscle group.</a><br><br>"  + 
				 //"            <a href=\"delete-item.jsp?id=" + rs.getString("id") + "&table=muscle_group\">Delete muscle group.</a><br>"  + 
				 "             <br>  "  + 
				 "             <br>  "  + 
				 "             <br>  "  + 
				 "         </div>  "  + 
