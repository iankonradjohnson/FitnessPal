...
<div class="main">
	...
	<hr>
	<h1><i class="fas fa-dumbbell"></i> Add Muscle Group</h1>
	<p> To add a muscle group to the database, please fill out the following fields:</p>
  
  	<form id="add-muscle-group" action="AddMuscleGroupServlet" method="post" enctype="multipart/form-data">
  		<section class="first">
