...
<div class="main">
  ...
  <hr>
  <h1><i class="fas fa-swimmer"></i> Edit Equipment </h1>
  	...
  	<form id="edit-equipment" action="EditEquipment?id=<%=  rs.getString("id") %>" method="post" enctype="multipart/form-data">
  		<section class="first">
          	<fieldset class="first_fieldset">
              	...
              	<input type="text" name = "name" style="width:100%" size="25" value = "<%= rs.getString("name") %>" ><br>
              	
              	<label> Description: </label>
  				<textarea name="description"><%= rs.getString("description") %></textarea><br> 
  				
  				<label> Type: </label>
              	<select name="workout_type" style="width:100%">
              		<% 
