...
<div class="main">
	...
	<hr>
	<h1><i class="fas fa-dumbbell"></i> Add Equipment</h1>
	<p> To add equipment to the database, please fill out the following fields:</p>
  
  	<form id="add-equipment" action="AddEquipmentServlet" method="post" enctype="multipart/form-data">
  		<section class="first">
