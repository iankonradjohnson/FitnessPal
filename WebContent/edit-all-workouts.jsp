...
String dbURL = "jdbc:mysql://localhost:3306/MyFitnessPal";
Connection connection = DriverManager.getConnection(dbURL, "root", "BACHlover1234");  
String query = "SELECT * FROM workout WHERE user = ?";
PreparedStatement pstmt = connection.prepareStatement(query);   
...
<div class="main">
  ...
  <hr>
  <h1><i class="fas fa-edit"></i> Edit Your Uploaded Workouts </h1>
...
if(rs.next() == false){
	...
	do{	
		out.println("<div class=\"row\">  "  + 
				 "       <div class=\"column2\">  "  + 
				 "         <a href=\"edit-workout.jsp?id=" + rs.getString("id") + "\">" +
				 "          <div class=\"container2\">  "  + 
				 "			 <img src=\"./ImageServlet?id=" + rs.getString("id") + "&table=workout\" height=\"400\" align=\"middle\" style=\"display:block; margin:auto; max-width:100%; height:auto; max-height:400px;\">  "  + 
				 "             <div class=\"middle\">  "  + 
	             ...
	             writeEquipmentHTML(rs.getString("equipment_ids"), out)+ 
	             writeMusclesHTML(rs.getString("muscle_ids"), out)+ 
				 "           <br><a href=\"edit-workout.jsp?id=" + rs.getString("id") + "\">Click here to edit workout.</a><br><br>"  + 
				 //"            <a href=\"delete-item.jsp?id=" + rs.getString("id") + "&table=workout\">Delete workout.</a><br>"  + 
				 "             "  + 
				 "             <br>  "  + 
				 "             <br>  "  + 
				 "             <br>  "  + 
